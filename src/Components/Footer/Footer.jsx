				...
				<div className=" px-4 pb-8 pt-16 sm:px-6 lg:px-8">
					<div className="mx-auto max-w-md">
						<strong className="block text-center text-xl font-bold text-text-one sm:text-3xl">
							Subscribe To Our
							<span className=" inline-block ml-2 text-violet-500">
								Newsleater
							</span>
						</strong>
						...
						<form className="mt-6">
							<div className="relative max-w-lg">
								...
								<input
									className="w-full rounded-full border-gray-200 bg-gray-100 p-4 pe-32 text-sm font-medium focus:border-violet-500 "
									id="email"
									type="email"
									placeholder="example@gmail.com"
								/>

								<button className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-violet-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-violet-600 duration-300 ease-in-out">
									Subscribe
								</button>
							</div>
						</form>
						...
						<div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
							<div>
								...
								<ul className="mt-6 space-y-1">
									<li>
										<a
											className="text-gray-700 hover:underline text-sm transition duration-300 ease-linear hover:text-violet-500"
											href="/"
										>
											Events
										</a>
					...
					<div className="mt-16 border-t border-gray-100 pt-8">
						<p className="text-center text-xs/relaxed text-gray-500">
							...
							<a
								href=""
								className="text-gray-700 hover:underline transition duration-300 ease-linear hover:text-violet-500"
							>
								💖
							</a>
							by
							<a
								href=""
								className="text-gray-700 hover:underline transition duration-300 ease-linear hover:text-violet-500 ml-1"
							>
								Imran
							</a>
							.
