	...
	return (
		<div className="font-inter leading-relaxed">
			<nav className="container mx-auto flex items-center justify-between py-5">
				...
				<div
					className=" hover:cursor-pointer  bg-violet-500 hover:bg-violet-600 px-8 py-2 ring-4 ring-violet-200  text-white rounded-lg duration-300 ease-in-out hover:shadow-lg
